    ...
    return (
      <section className={cn("border-border/60 border-t pt-8", className)}>
        ...
        <p className="text-muted-foreground mt-2 max-w-xl text-sm leading-relaxed">
          Your Kundli stays with you. Switch to Matrimony for discovery, interest, and compatibility
          — Astrology mode stays focused on your chart.
        </p>
  ...
  return (
    <section className={cn("border-border/60 border-t pt-8", className)}>
      ...
      <p className="text-muted-foreground mt-2 max-w-xl text-sm leading-relaxed">
        ...
        themes. Open your Kundli or explore insights in Astrology mode.
      </p>
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        <Button
          type="button"
        ...
        <Button asChild variant="outline" className="w-full sm:w-auto">
          <Link href={routes.kundli}>View Kundli</Link>
        </Button>
      </div>
    </section>
  );
