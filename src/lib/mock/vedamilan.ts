    ...
    messages: [
      {
        id: "1",
        from: "them",
        text: "Namaste Aditi—your profile felt unusually thoughtful.",
        time: "09:12",
      },
      {
        id: "2",
...
export const mockReports = [
  ...
  {
    id: "r2",
    title: "Compatibility · Aditi × Arjun",
    type: "PDF",
    size: "1.8 MB",
    date: "11 Jul 2026",
    status: "Ready",
...
export const mockFaqs = [
  ...
  },
  {
    ...
    a: "Birth details are stored securely and never shown publicly without your consent. You control profile visibility from Settings.",
  },
  {
